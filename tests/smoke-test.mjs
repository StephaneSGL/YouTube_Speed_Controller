...
for (const path of ["popup.html", "popup.css", "popup.js", "content.css", "content.js", "tests/player-harness.html"]) {
...
assert.match(contentSource, /const MIN_SPEED = 0\.25/);
assert.match(contentSource, /const MAX_SPEED = 16/);
assert.match(contentSource, /playbackRate = speed/);
assert.match(contentSource, /Math\.max\(0\.05, numeric\)/);
